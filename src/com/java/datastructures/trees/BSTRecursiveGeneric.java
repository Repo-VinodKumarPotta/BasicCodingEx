...
public class BSTRecursiveGeneric<T extends Comparable<T>> {
  ...
  public static void main(String[] args) {
    ...
    // Integer
    com.java.datastructures.trees.BSTRecursiveGeneric<Integer> integerTree = new com.java.datastructures.trees.BSTRecursiveGeneric<Integer>();
    ...
    */
    ...
    // String
    com.java.datastructures.trees.BSTRecursiveGeneric<String> stringTree = new com.java.datastructures.trees.BSTRecursiveGeneric<String>();
