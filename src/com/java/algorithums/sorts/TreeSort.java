package com.java.algorithums.sorts;

import static com.java.algorithums.sorts.SortUtils.print;
...
public class TreeSort implements SortAlgorithm {
  ...
  private <T extends Comparable<T>> T[] doTreeSortArray(T[] unsortedArray) {
    ...
    com.java.datastructures.trees.BSTRecursiveGeneric<T> tree = new com.java.datastructures.trees.BSTRecursiveGeneric<T>();
  ...
  public static void main(String[] args) {
    ...
    List<Integer> intList = Arrays.asList(3, -7, 45, 1, 343, -5, 2, 9);
    System.out.print(String.format("%-10s", "unsorted: "));
    print(intList);
    ...
    List<String> stringList = Arrays.asList ("banana", "berry", "orange", "grape", "peach", "cherry", "apple", "pineapple");
    System.out.print(String.format("%-10s", "unsorted: "));
    print(stringList);
